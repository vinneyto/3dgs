...
import { mulberry32, randRange } from "@/app/_shared/lib/random";
import { SplatInstanceStruct } from "@/app/_shared/tsl/gaussian/splatInstanceStruct";
import { createInstancedEllipsoidNodes } from "@/app/_shared/tsl/gaussian/instancedEllipsoid";
...
export default function InstancedSplatsPage() {
  const [regenTick, setRegenTick] = useState(0);

  const { count, seed, cutoff, showMeshes } = useControls(
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        ...
        <div className="muted">
          File: <code>app/(pages)/instanced/page.tsx</code>
        </div>
      </div>
