...
import { createInstancedBillboardCircleNodes } from "@/app/_shared/tsl/billboard/instancedBillboardCircle";
import { WebGPUCanvasFrame } from "@/app/_shared/webgpu/WebGPUCanvasFrame";

export default function BillboardCirclePage() {
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        ...
        <div className="muted">
          File: <code>app/(pages)/billboard-circles/page.tsx</code>
        </div>
      </div>
