...
import { DirectionSphereWidget } from "@/app/_shared/components/DirectionSphereWidget";
import { useDirectionSphereWidgetDrag } from "@/app/_shared/hooks/useDirectionSphereWidgetDrag";
import { createShSphereL1Nodes } from "@/app/_shared/tsl/sh/shSphereL1";
...
export default function ShSphereDemoPage() {
  const {
    c0,
    cY,
    cZ,
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        ...
        <p className="muted">
          Drag the satellite along the orbit sphere to define a direction.
        </p>
        <div className="muted">
          File: <code>app/(pages)/sh-sphere/page.tsx</code>
        </div>
      </div>
