...
} from "@/app/_shared/tsl/billboard/storageBillboardCircle";
...
export default function BillboardCircleStoragePage() {
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        ...
        <div className="muted">
          File: <code>app/(pages)/billboard-circles-buffer/page.tsx</code>
        </div>
      </div>
