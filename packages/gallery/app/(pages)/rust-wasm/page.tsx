...
import { parseSplatPly } from "@/app/_shared/loaders/ply";
import { useRustPlyParse } from "@/app/_shared/hooks/useRustPlyParse";
...
export default function RustWasmPlyParsePage() {
  ...
  return (
    <div className="page">
      <div className="pageHeader">
        <h1>PLY parsing via Rust WASM</h1>
        <p className="muted">
        ...
        <div className="muted">
          File: <code>app/(pages)/rust-wasm/page.tsx</code>
        </div>
      </div>
